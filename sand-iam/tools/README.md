...
php sand-iam/tools/sign-release-bundle.php \
  ...
  --archive=/controlled/candidate/sand-iam-0.7.3-release-unsigned.zip \
...
the normal 0.7.3 payload, verifies ZIP contents and source-snapshot parity,
...
included in normal 0.7.3 candidates, and do not authorize a 0.6.0 direct upgrade.
