...
// A SandPackage upgrade must never replay historical lifecycle input. 0.7.1
// admits only a completed 0.7.0 ledger through 037, then applies the original
// 038 migration exactly once. The admission gate is lifecycle input rather
