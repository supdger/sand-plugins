...
final class ProviderConfig
{
    ...
    public static function fromEnvironment(): self
    {
        return self::fromArray(array_combine(
            ['SAND_IAM_BASE_URL','SAND_IAM_ORGANIZATION_CODE','SAND_IAM_APPLICATION_CODE','PROVIDER_B_DATABASE_DSN','PROVIDER_B_DATABASE_USER','PROVIDER_B_DATABASE_PASSWORD'],
            array_map('getenv', ['SAND_IAM_BASE_URL','SAND_IAM_ORGANIZATION_CODE','SAND_IAM_APPLICATION_CODE','PROVIDER_B_DATABASE_DSN','PROVIDER_B_DATABASE_USER','PROVIDER_B_DATABASE_PASSWORD'])
        ));
    }
    ...
    public static function fromArray(array $env): self
    {
        ...
        return new self($url, $org, $app, $dsn, $get('PROVIDER_B_DATABASE_USER'), $get('PROVIDER_B_DATABASE_PASSWORD'));
    }
}
