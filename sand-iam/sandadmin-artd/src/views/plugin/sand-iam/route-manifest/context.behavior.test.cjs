...
const code = ts.transpileModule(`${body}; globalThis.page = { manifestText, preview, requestError, disableMissing, previewKind, runPreview, confirmApply, acting, issuedCredential, applied, acknowledgeCredential };`,
